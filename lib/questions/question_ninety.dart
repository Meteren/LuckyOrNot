...
class QuestionNinety extends StatefulWidget {
  ...
  @override
  State<QuestionNinety> createState() => _QuestionNinetyState();
}

class _QuestionNinetyState extends State<QuestionNinety> {
  late int active;
  late int pointTaken;
