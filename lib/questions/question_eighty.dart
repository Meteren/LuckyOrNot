...
class QuestionEighty extends StatefulWidget {
  ...
  @override
  State<QuestionEighty> createState() => _QuestionEightyState();
}

class _QuestionEightyState extends State<QuestionEighty> {
  late int active;
  late int pointTaken;
