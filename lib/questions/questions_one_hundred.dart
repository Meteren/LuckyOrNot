...
class QuestionOneHundred extends StatefulWidget {
  ...
  @override
  State<QuestionOneHundred> createState() => _QuestionOneHundredState();
}

class _QuestionOneHundredState extends State<QuestionOneHundred> {
  late int active;
  late int pointTaken;
